...
const TYPE_SINGLE = "single" as const; // single select
const TYPE_MULTI = "multi" as const;   // multi select
const TYPE_OPEN = "open" as const;     // open-ended
...
export function updateOptionInList(
  options: string[] = [],
  index: number,
  value: string
) {
...
export default function ScreenerBuilderApp() {
    ...
    return library
      .map((q) => ({
        ...
        score:
          ...
          specTokens.reduce(
            (acc, tok) => acc + (q.text.toLowerCase().includes(tok) ? 1 : 0),
            0
          ),
      }))
      .filter((o) => o.score > 0)
    ...
    const standard: Q[] = [
      {
        ...
        type: TYPE_OPEN,
        text: "Recruiter Intro Script",
        options: [],
        instructions: "READ STANDARD INTRO; CONFIRM CONFIDENTIALITY; NOT A SALES CALL.",
        tags: ["standard"],
      },
      {
        id: rid(),
        ...
        type: TYPE_SINGLE,
        text: "Record Gender",
        options: ["Male", "Female", "Non-binary", "Prefer to self-identify"],
        instructions: "APPLY GENDER QUOTAS PER SPECS.",
        tags: ["standard", "gender"],
      },
      {
        id: rid(),
        section: "Eligibility",
        type: TYPE_SINGLE,
        text: "Have you participated in a market research group/interview before?",
        options: ["Yes", "No"],
        instructions:
          "IF YES, ASK RECENCY & FREQUENCY FOLLOW-UPS; TERMINATE IF TOO RECENT.",
        tags: ["standard", "participation"],
      },
      {
        id: rid(),
        section: "Eligibility",
        type: TYPE_SINGLE,
        text: "How long ago did you participate?",
        options: ["Within the past 3 months", "3–6 months ago", "Longer than 6 months ago"],
        instructions: "TERMINATE IF WITHIN PAST 3 MONTHS (UNLESS OTHERWISE SPECIFIED).",
        tags: ["standard"],
      },
      {
        id: rid(),
        section: "Eligibility",
        type: TYPE_OPEN,
        text: "Approximately how many research sessions in the past year?",
        options: [],
        instructions: "TERMINATE IF >4 IN 12 MONTHS (UNLESS OTHERWISE SPECIFIED).",
        tags: ["standard"],
      },
      {
        id: rid(),
        ...
        options: [
          ...
          "CPG manufacturing (category relevant)",
          "Other restricted",
        ],
        instructions: "TERMINATE IF ANY RESTRICTED INDUSTRY SELECTED.",
        tags: ["standard", "screenout"],
      },
      {
        id: rid(),
        section: "Eligibility",
        ...
        options: [],
        instructions: "TERMINATE IF OUT OF RANGE PER SPEC (E.G., 18–54).",
        tags: ["standard", "age"],
      },
      {
        id: rid(),
        section: "Household Shopping",
        type: TYPE_SINGLE,
        text: "How much of the household category shopping do you do?",
        options: ["All of it", "Half or more", "Less than half", "None"],
        instructions: "TERMINATE IF LESS THAN HALF.",
        tags: ["standard"],
      },
      {
        id: rid(),
        section: "Category Usage",
        type: TYPE_SINGLE,
        text: "How often do you purchase/consume this category?",
        options: [
          "Once a week",
          "Every 2 weeks",
          "Once a month",
        ...
        instructions: "TERMINATE PER FREQUENCY THRESHOLDS IN SPEC.",
        tags: ["standard", "usage"],
      },
      {
        id: rid(),
        section: "Brands",
        type: TYPE_MULTI,
        text: "Which brands have you purchased in the past 3 months? (Add list)",
        options: ["Brand A", "Brand B", "Brand C", "Other"],
        instructions:
          "ADD MOST OFTEN AND REJECT FOLLOW-UPS; CLASSIFY USERS/NON-USERS.",
        tags: ["standard", "brands"],
      },
      {
        id: rid(),
        section: "Articulation",
        type: TYPE_OPEN,
        text: "Tell me about your most recent experience in this category.",
        options: [],
        instructions: "ASSESS CLARITY & ENTHUSIASM; AVOID RELUCTANT/TIMID.",
        tags: ["standard", "articulation"],
      },
      {
        id: rid(),
        ...
        type: TYPE_SINGLE,
        text: "Marital status",
        options: ["Married/living with someone", "Single", "Divorced/separated", "Widowed"],
        instructions: "RECRUIT A MIX UNLESS SPECIFIED.",
        tags: ["standard", "demo"],
      },
      {
        id: rid(),
        ...
        instructions: "RECRUIT A MIX PER SPEC.",
        tags: ["standard", "demo"],
      },
      {
        id: rid(),
        ...
        options: [
          ...
          "Some Post-Grad or more",
        ],
        instructions: "TERMINATE IF SOME HS OR LESS (TYPICAL).",
        tags: ["standard", "demo"],
      },
      {
        id: rid(),
        ...
        instructions:
          "AIM FOR MIX; OFTEN 80% FT. TERMINATE IF 'CURRENTLY SEEKING' AS REQUIRED.",
        tags: ["standard", "employment"],
      },
      {
        id: rid(),
        section: "Employment",
        type: TYPE_OPEN,
        text: "Occupation / Industry (and spouse if married)",
        options: [],
        instructions: "CHECK AGAINST SCREEN-OUT LIST.",
        tags: ["standard", "employment"],
      },
      {
        id: rid(),
        section: "Income",
        type: TYPE_SINGLE,
        text: "Total annual household income",
        options: [
          "< $30k",
          "$30–44.9k",
          "$45–59.9k",
        ...
        instructions: "RECRUIT MIX; ADJUST PER SPEC.",
        tags: ["standard", "income"],
      },
      {
        id: rid(),
        section: "Logistics",
        type: TYPE_OPEN,
        text: "Device/Connection Check (Online only)",
        options: [],
        instructions:
          "ASK WEBCAM/LAPTOP, INTERNET SPEED, COMFORT WITH TECH – ONLINE ONLY.",
        tags: ["standard", "device"],
      },
      {
        id: rid(),
        section: "Invitation",
        type: TYPE_OPEN,
        text: "Invitation & Incentive Script",
        options: [],
        instructions:
          "CONFIRM AVAILABILITY; INCENTIVE; EARLY ARRIVAL NOTE; RCDA/CONSENT.",
        tags: ["standard", "invite"],
      },
    ];
  ...
  function importCSV(text: string) {
    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      const tagList = tags
        ? tags.split(";").map((s) => s.trim().toLowerCase()).filter(Boolean)
        : [];
      ...
      out.push({
        ...
        section,
        text: question,
        type: ([TYPE_SINGLE, TYPE_MULTI, TYPE_OPEN] as string[]).includes(type)
          ? (type as QType)
          : TYPE_SINGLE,
        options,
        instructions: instr,
        ...
        styles: {
          paragraphStyles: [
            ...
            },
            {
              ...
              name: "Heading 2",
              basedOn: "Normal",
              run: { size: H2_SIZE, bold: true, color: BRAND_MAGENTA, font: "Calibri" },
            },
            {
              id: "Body",
              name: "Body",
        ...
        sections: [
          {
            ...
            children: [
              ...
              location
                ? new Paragraph({ text: `Location/Platform: ${location}` })
                : new Paragraph({ text: "" }),
              new Paragraph({ text: `Category: ${category}` }),
              specs ? new Paragraph({ text: specs }) : new Paragraph({ text: "" }),
              new Paragraph({ text: "" }),
              new Paragraph({
                text: "Recruitment Screener (Behaviorally Standard)",
              ...
              ...builderQs
                ...
                .flatMap((q, idx) => {
                  ...
                  // Numbered question (no section headers in export)
                  parts.push(
                    new Paragraph({
                      children: [new TextRun({ text: `${idx + 1}. ${q.text}` })],
                    })
                  );

                  // Options (a., b., c...) for non-open-ended
                    ...
                    for (let i = 0; i < opts.length; i++) {
                      parts.push(
                        new Paragraph({
                          children: [
                            new TextRun({
                              text: `  ${String.fromCharCode(97 + i)}. ${opts[i]}`,
                            }),
                          ],
                        })
                      );
                  ...
                  // Recruiter instructions — magenta, ALL CAPS, italic
                  if (q.instructions) {
                    parts.push(
                      new Paragraph({
                        children: [
                          new TextRun({
                            text: (q.instructions || "").toUpperCase(),
                            color: BRAND_MAGENTA,
                            italics: true,
                          }),
                        ],
      ...
      builderQs
        ...
        .map((q, i) => {
          ...
          const ri = q.instructions
            ? `<p style="color:#${BRAND_MAGENTA};font-style:italic">${(q.instructions || "")
                .toUpperCase()}</p>`
            : "";
        ...
        {lastDownload && (
          <div className="mx-auto max-w-7xl px-4 pb-3">
            <div className="text-xs text-slate-600 bg-slate-100 border border-slate-200 rounded p-2">
              ...
              <button
                className="underline"
                onClick={() => window.open(lastDownload.url, "_blank")}
              >
                open in a new tab
              </button>
              .
        ...
        <section className="col-span-3 space-y-4">
          <div className="bg-white rounded-2xl shadow p-4 space-y-3">
            ...
            <input
              ...
              placeholder="ShopperLab Teaneck, NJ or Zoom"
            />

            <div className="mt-2 text-xs text-slate-500">
              Company logo is applied automatically to exports.
            </div>
            ...
            <textarea
              ...
              placeholder={"Paste schedule, quotas, address block as in the template..."}
            />
            ...
            <textarea
              ...
              placeholder="Targets, quotas, time frame, channels, etc."
            />

            <button
              className="px-3 py-2 rounded bg-slate-900 text-white w-full"
              onClick={loadBehaviorallyStandard}
            >
          ...
          <div className="bg-white rounded-2xl shadow p-4 space-y-3">
            ...
            <div className="text-xs text-slate-500">
              {mode === MODE_ONLINE
                ? "Online: device checks will be included"
                : "In-person: device checks will be omitted in export"}
            </div>
            <div className="space-y-2 max-h-[320px] overflow-auto pr-1">
              {suggested.length === 0 && (
                <div className="text-sm text-slate-500">
                  No suggestions yet. Add specs or change category.
                </div>
              )}
              {suggested.map((q) => (
          ...
          <div className="bg-white rounded-2xl shadow p-4 space-y-3">
            ...
            <p className="text-xs text-slate-600">
              Columns: Section, Question, Type(single|multi|open), Options(; separated), Instructions, Tags(; separated)
            </p>
            <textarea
              id="csv"
          ...
          <div className="bg-white rounded-2xl shadow p-4">
            ...
            {builderQs.length === 0 ? (
              <div className="text-sm text-slate-500 mt-4">
                Use <strong>Load Behaviorally Standard Order</strong>, then tweak with{" "}
